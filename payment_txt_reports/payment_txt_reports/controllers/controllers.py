...
class Binary(http.Controller):
    ...
    @http.route('/web/binary/download_document_tss', type='http', auth="public")
    @serialize_exception
    def download_document_tss(self, model, id, filename=None, **kw):
